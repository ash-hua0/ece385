...
simulate()
{
  xsim  mb_usb -key {Behavioral:sim_1:Functional:mb_usb} -tclbatch cmd.tcl -protoinst "protoinst_files/mb_usb.protoinst" -protoinst "protoinst_files/mb_block.protoinst" -log simulate.log
}
