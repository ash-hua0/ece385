...
HD_PWD='C:/Users/Orion/Documents/GitHub/ece385/lab_7/lab_7.runs/mb_block_i_microblaze_0_axi_intc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_block_i_microblaze_0_axi_intc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_block_i_microblaze_0_axi_intc_0.tcl
