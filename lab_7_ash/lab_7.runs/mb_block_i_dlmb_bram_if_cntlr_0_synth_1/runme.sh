...
HD_PWD='C:/Users/Shane/Documents/Classes/ECE_385/Lab_7/lab_7_ash/lab_7.runs/mb_block_i_dlmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_block_i_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_block_i_dlmb_bram_if_cntlr_0.tcl
