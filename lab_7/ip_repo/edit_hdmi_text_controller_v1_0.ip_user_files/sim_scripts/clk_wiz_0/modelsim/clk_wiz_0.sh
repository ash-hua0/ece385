...
#
# Generated by Vivado on Tue Oct 29 23:44:13 -0500 2024
...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/Orion/Documents/GitHub/ece385/lab_7/ip_repo/edit_hdmi_text_controller_v1_0.cache/compile_simlib/modelsim"
  fi
