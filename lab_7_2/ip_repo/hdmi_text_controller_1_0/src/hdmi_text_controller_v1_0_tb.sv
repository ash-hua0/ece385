...
module hdmi_text_controller_tb();
    ...
    // Pixel clock, hs, vs, and vde (!blank)
    ...
    initial begin: TEST_VECTORS
        ...
        /*
        #10;
        force hdmi_text_controller_v1_0_inst.sram_addra = 11'b00000000000;
        force hdmi_text_controller_v1_0_inst.sram_dina = 32'h1234ABCD;
        force hdmi_text_controller_v1_0_inst.sram_wea = 4'b0111;
        force hdmi_text_controller_v1_0_inst.sram_ena = 1'b1;
        #10;
        //force hdmi_text_controller_v1_0_inst.sram_dina = 32'h0000000;
        force hdmi_text_controller_v1_0_inst.sram_wea = 4'b0000;
        #20;
        $display("Reading data stored in BRAM, got %h", sram_douta);
        force hdmi_text_controller_v1_0_inst.sram_addra = 11'b00000000001;
        #20;
        force hdmi_text_controller_v1_0_inst.sram_ena = 1'b0;
        #10;
        force hdmi_text_controller_v1_0_inst.sram_addra = 11'b00000000000;
        force hdmi_text_controller_v1_0_inst.sram_ena = 1'b1;
