...
load_reg #(.DATA_WIDTH(16)) mdr_reg (
    ...
    .load   (ld_mdr),
    .data_i (mem_rdata), //REPLACE WITH MIO MUX
...
mux_bus mux_bus (
    .A0(16'h0000), //CONNECT TO MARMUX 
    .A1(pc), 
    .A2(16'h0000), //CONNECT TO GATEALU
    .A3(mdr),
    
    .S({gate_mdr, gate_alu, gate_pc, gate_marmux}),   //CONNECT TO CONTROL UNIT
    .C(data_bus)
);
